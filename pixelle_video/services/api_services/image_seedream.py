...
class SeedreamClient:
    ...
    def generate_image(
        ...
        **kwargs
        ...
        if image_paths and len(image_paths) > 0:
            # Handle reference images: support URLs and local files
            ref_images = []
        ...
        # Call the API
        if image_paths and len(image_paths) > 0:
            # Image-to-image - image is placed in extra_body
    ...
    def _download_image(self, url: str, session_id: str, idx: int) -> Optional[str]:
        """Download an image from a URL to local"""
        import requests
...
if __name__ == "__main__":
    ...
    prompt = "Interstellar, a black hole, a shattered vintage train bursting out of the black hole, visually striking, cinematic blockbuster, apocalyptic vibe"
    ...
    # Requires the path to an existing reference image
    ...
    if os.path.exists(ref_image_path):
        ...
        print("  Skipping the image-to-image test; run the text-to-image test first to generate a reference image")
