...
Text-to-video (text2video) / image-to-video (image2video) built on the Kling API
...
class _TLSAdapter(HTTPAdapter):
    """HTTPS adapter that forces TLS 1.2, for compatibility with older LibreSSL"""
...
def _build_session(max_retries: int = 3) -> requests.Session:
    """Create a requests Session with the TLS adapter and automatic retries"""
...
class KlingVideoClient:
    """
    Kling AI video generation client
    Uses JWT (HMAC-SHA256) authentication to call the /v1/videos/text2video or /v1/videos/image2video endpoints
    """
    ...
    def __init__(
        ...
        Args:
            ...
            token_ttl:  JWT lifetime (seconds), default 30 minutes
        ...
        # Session with forced TLS 1.2 + automatic retries
    ...
    def _encode_image(image_path: str, quality: int = 85) -> str:
        ...
        Kling requirement: do not add the data:image/xxx;base64, prefix, pass the Base64 string directly
    ...
    def _submit_task(
        ...
        Args:
            ...
            duration: video length, v3: "3"~"15", v2: "5" or "10"
            cfg_scale: freedom [0,1], higher means closer to the prompt
        ...
        # v3 / v2-6: sound on by default, unless sound="off" is explicitly set
    ...
    def generate_video(
        ...
        Args:
            ...
            duration: video length (seconds), v3: 3~15, v2: 5 or 10
