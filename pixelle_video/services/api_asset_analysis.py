...
class APIAssetAnalysisService:
    ...
    IMAGE_PROMPT = """Please analyze this asset image and provide a concise description in English suitable for short-video script creation.

Please focus on:
1. The main subject, people/products/scene
2. Key information usable for marketing or storytelling
3. The visual style, mood, colors, and composition

Output 2-5 sentences. Do not fabricate information that is not present in the image."""
...
3. The overall style, pacing, and mood

Output 3-6 sentences. Do not fabricate information that cannot be seen in the key frames."""
